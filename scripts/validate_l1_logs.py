...
SCENARIO_CONTRACTS = {
    ...
    # The test plan also asks that the open carry no link data; that is a
    # field-level assertion, and this layer is bounded at counts and
    # required-field presence, so only the endpoint half is covered here.
    "install": {
