...
class NavigateContentVC: ParentViewController {
    ...
    override func viewWillAppear(_ animated: Bool) {
        ...
        Utils.shared.setLogFile("NavigateContent")
    }
