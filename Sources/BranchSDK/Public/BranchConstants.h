...
// Operational Metrics Param Keys
extern NSString * const BRANCH_REQUEST_KEY_OPERATIONAL_METRICS;
extern NSString * const BRANCH_REQUEST_KEY_DEFER_INIT_FOR_PLUGIN_RUNTIME;
extern NSString * const BRANCH_REQUEST_KEY_CHECK_PASTEBOARD_ON_INSTALL;

extern NSString * const BRANCH_REQUEST_KEY_BRANCH_KEY_SOURCE;
extern NSString * const BRANCH_KEY_SOURCE_UNKNOWN;
extern NSString * const BRANCH_KEY_SOURCE_GET_INSTANCE_API;
extern NSString * const BRANCH_KEY_SOURCE_SET_BRANCH_KEY_API;
extern NSString * const BRANCH_KEY_SOURCE_INIT_FUNCTION;
extern NSString * const BRANCH_KEY_SOURCE_CONFIG_JSON;
extern NSString * const BRANCH_KEY_SOURCE_INFO_PLIST;

extern NSString * const BRANCH_REQUEST_KEY_LINKED_FRAMEORKS;
extern NSString * const FRAMEWORK_ATT_TRACKING_MANAGER;
extern NSString * const FRAMEWORK_AD_SUPPORT;
