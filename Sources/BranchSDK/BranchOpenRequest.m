...
- (void)processResponse:(BNCServerResponse *)response error:(NSError *)error {
    ...
    [[BranchLogger shared] logVerbose:[NSString stringWithFormat:@"Test Logs ********** URL: %@ Request: %@ Response: %@ error:  %@", self.urlString, self.requestParams, response.data, [error description ]] error:nil];
