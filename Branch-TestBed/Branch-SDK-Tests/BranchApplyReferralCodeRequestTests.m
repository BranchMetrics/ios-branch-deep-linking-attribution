...
@interface BranchApplyReferralCodeRequestTests : BranchTest

@end

@implementation BranchApplyReferralCodeRequestTests
...
- (void)testRequestBodyWithAllItemsSpecified {
    ...
    BranchApplyReferralCodeRequest *request = [[BranchApplyReferralCodeRequest alloc] initWithCode:CODE callback:NULL];
...
- (void)testBasicSuccess {
    ...
    BranchApplyReferralCodeRequest *request = [[BranchApplyReferralCodeRequest alloc] initWithCode:CODE callback:^(NSDictionary *params, NSError *error) {
