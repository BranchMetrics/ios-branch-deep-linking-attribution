...
@property (nonatomic, strong, readwrite, copy) NSString *appGroup;

// App Clip data
@property (nonatomic, strong, readwrite, copy) NSString *bundleID;
@property (nonatomic, strong, readwrite) NSDate *installDate;
@property (nonatomic, strong, readwrite, copy) NSString *url;
@property (nonatomic, strong, readwrite, copy) NSString *branchToken;
@property (nonatomic, strong, readwrite, copy) NSString *bundleToken;
