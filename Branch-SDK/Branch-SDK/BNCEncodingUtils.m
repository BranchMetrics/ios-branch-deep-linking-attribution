...
+ (NSDictionary *)decodeJsonStringToDictionary:(NSString *)jsonString {
    ...
    NSDictionary *plainDecodedDictionary = [NSJSONSerialization JSONObjectWithData:tempData options:0 error:nil];
    ...
    NSDictionary *base64DecodedDictionary = [NSJSONSerialization JSONObjectWithData:tempData options:0 error:nil];
