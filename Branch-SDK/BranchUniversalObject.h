...
@property (nonatomic, strong, nullable, copy) NSString        *sku;
@property (nonatomic, strong, nullable, copy) NSString        *productName;
@property (nonatomic, strong, nullable, copy) NSString        *productBrand;
@property (nonatomic, strong, nullable) BNCProductCategory productCategory;
@property (nonatomic, strong, nullable, copy) NSString        *productVariant;
...
@property (nonatomic, strong, nullable, copy) NSString        *addressStreet;
@property (nonatomic, strong, nullable, copy) NSString        *addressCity;
@property (nonatomic, strong, nullable, copy) NSString        *addressRegion;
@property (nonatomic, strong, nullable, copy) NSString        *addressCountry;
@property (nonatomic, strong, nullable, copy) NSString        *addressPostalCode;
...
@property (nonatomic, strong, nullable, copy) NSString *canonicalIdentifier;
@property (nonatomic, strong, nullable, copy) NSString *canonicalUrl;
@property (nonatomic, strong, nullable, copy) NSString *title;
@property (nonatomic, strong, nullable, copy) NSString *contentDescription;
@property (nonatomic, strong, nullable, copy) NSString *imageUrl;
