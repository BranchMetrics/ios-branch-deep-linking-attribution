...
@property (nonatomic, strong, copy) NSString*_Nullable title;
...
@property (nonatomic, strong, copy) NSString*_Nullable shareText;
...
@property (nonatomic, strong, copy) NSString*_Nullable emailSubject;
...
@property (nonatomic, strong, readonly, copy) NSString*_Nullable activityType;
